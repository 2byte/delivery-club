...
export class ServerScaffoldGenerator {
  ...
  private getReadmeTemplate(): string {
    return [
      ...
      "```",
      "",
      "## Host Management (deliverierCli.ts)",
      "",
      ...
      "",
      "```bash",
      "bun deliverierCli.ts add --name \"Production\" --hostname \"prod.example.com\" --encryption \"AES-256\" --key \"secret\"",
      "```",
      "",
      "### Get host details",
      "",
      ...
      "",
      "```bash",
      "bun deliverierCli.ts update host_1 --hostname \"new.example.com\"",
      "```",
      "",
      "### Delete a host",
      "",
      ...
      "",
      "```bash",
      "bun deliverierCli.ts init --dir ./new-app",
      "bun deliverierCli.ts init --dir ./new-app --force --host-port 8080",
      "```",
      "",
      "## Storage",
      "",
